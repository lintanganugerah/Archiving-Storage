...
<div class="row">
    <div class="col">
        ...
        <form action="{{ route('admin.attemptPassword') }}" method="POST" class="mx-2 mb-5">
            @csrf
            <div class="mb-3">
                ...
                <div id="namaNasabah" class="form-text">Hubungi admin cabang jika anda lupa password</div>
            </div>
            <div class="mb-3">
