...
<div class="row">
    <div class="col">
        ...
        @endif
        <form action="{{ route('admin.ubahProfile') }}" method="POST" class="mx-2 mb-5">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div id="namaNasabah" class="form-text">Password digunakan untuk verifikasi bahwa user benar ingin melakukan perubahan. <a href="{{ route('admin.profileresetPassword') }}" class="text-danger">Klik disini jika anda ingin ubah password</a> </div>
            </div>
